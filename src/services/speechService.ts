...
class SpeechService {
    ...
    try {
      ...
      switch (style) {
        ...
        case 'patsan':
          ...
          break;
        case 'baba_klava':
          // Баба Нюра — высокий бабушкин тон
          charPitch = 1.3;
          charRate = 0.92;
          break;
        case 'kaban':
          // Вор в законе Кабан — низкий, веский, авторитетный
          charPitch = 0.72;
          charRate = 0.88;
          break;
        case 'stockfish':
  ...
  public testVoice(style: CharacterStyle = 'nikolaich'): void {
    const testPhrases: Record<string, string> = {
      ...
      baba_klava: 'Ох, внучек, баба Нюра в карты играла когда тебя ещё на свете не было. Бери карты, не стесняйся.',
      kaban: 'Вечер в хату, фраера. Карты на стол, играем строго по понятиям.',
