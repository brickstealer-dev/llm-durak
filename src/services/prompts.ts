...
- Празднуй каждый удачный подкид и подкалывай тех, кто берет карты со стола.`
  ...
  baba_klava: {
    ...
    description: 'Добрая с виду бабушка, которая молча оставляет всех в дураках с генеральскими погонами.',
    temperature: 0.5,
    promptFlavor: `Твой стиль — бабушка Клава, которая играет в карты уже 60 лет:
...
- После рассуждений ОБЯЗАТЕЛЬНО добавь короткую сочную реплику оппоненту (1-2 предложения в твоем стиле/характере, трэшток или колкость) в теге <comment>Твоя реплика оппоненту</comment>.
