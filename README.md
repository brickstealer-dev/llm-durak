...
* **Честная валидация ходов**: Арбитр правил на TypeScript с строгой валидацией подкидывания, перевода карт, первого отбоя (до 5 карт) и ничьих.
* **Гибкий стол (2–6 игроков)**: Играйте 1 на 1 или собирайте компанию из людей и ИИ-ботов в любых комбинациях.

### 🤖 Продвинутый ИИ с личностью и эмоциями
* **6 уникальных колоритных персонажей**:
  * 🍺 **Николаич (Батя Двора)** — дворовый авторитет с житейской мудростью.
  * 🃏 **Моня «Золотая Рука»** — хитрый одесский шулер.
  * 🎓 **Профессор Аркадий** — теоретик вероятностей и комбинаторики.
  * 🧢 **Димон с Района** — дерзкий уличный пацанчик.
  * 👵 **Баба Клава** — добрая бабушка с пирожками и коварными козырями.
  * 🐗 **Кабан (Вор в законе)** — суровый смотрящий за столом.
...
* **🧠 Стриминг Chain-of-Thought**: Просматривайте скрытый мыслительный процесс нейросетей в реальном времени со счётчиком токенов в секунду.
...
* **Кинематографичный зелёный суконный стол** с реалистичными деревянными бортами, звуковыми эффектами сброса и козырей.
